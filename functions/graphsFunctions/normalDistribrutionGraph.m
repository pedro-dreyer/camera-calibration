function normalDistribrutionGraph(X1, YMatrix1)
...
% Create ylabel
ylabel('Absolute error in extraploated position (mm)','FontName','AvantGarde');

% Create xlabel
xlabel('Standart deviation','FontName','AvantGarde');

% Set the remaining axes properties
set(axes1,'FontSize',8,'LineWidth',1,'TickDir','out','TickLength',...
    [0.02 0.02],'XColor',[0.3 0.3 0.3],'XMinorTick','on','XTick',...
    [0 0.05 0.1 0.15 0.2 0.25 0.3],'YColor',[0.3 0.3 0.3],'YGrid','on','YMinorTick','on');
% Create legend
